...
public class Favorites extends BaseObservable implements Parcelable {
   ...
   */  @SerializedName("backdrop_path")
    ...
    public final static Parcelable.Creator<Favorites> CREATOR = new Creator<Favorites>() {
 ...
 */
    ...
    public Favorites(String posterPath, String originalTitle, String overview, Double voteAverage) {
        this.posterPath  = posterPath;
        this.originalTitle = originalTitle;
        this.overview = overview;
        this.voteAverage = voteAverage;
